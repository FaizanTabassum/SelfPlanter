...
void printPlantData(Plant plant) {
  ...
  display.print("hum = ");display.print(plant.humidity);display.print("%");display.print("    sm = ");display.print(plant.soil_moisture);display.println("%");
  display.print("Co2 = ");display.print(plant.co2_level);display.println("ppm");
...
void relaycontrol(){
  ...
  else{digitalWrite(humRelayPin, LOW);}
  ...
  else{digitalWrite(airQualityRelayPin, LOW);}
...
if (soilMoisture < soilMoistureThreshold-10) {
 if (soilMoisture < soilMoistureThreshold) {
  ...
  else{digitalWrite(soilMoistureRelayPin, LOW);}
